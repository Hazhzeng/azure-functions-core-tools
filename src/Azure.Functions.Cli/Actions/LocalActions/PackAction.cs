...
namespace Azure.Functions.Cli.Actions.LocalActions
{
    ...
    internal class PackAction : BaseAction
    {
        ...
        public override async Task RunAsync()
        {
            ...
            var zipStream = await ZipHelper.GetAppZipFile(workerRuntime, functionAppRoot, BuildNativeDeps, serverSideBuild: false, noBuild: false, additionalPackages: AdditionalPackages);
